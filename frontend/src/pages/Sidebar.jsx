...
const SIDEBAR_ITEMS = [
  { 
    label: 'All Mail',
    path: '/home', // This should be '/home' not '/home/dashboard'
    icon: (
  ...
  { 
    label: 'Saved', 
    path: '/home/savedmails', // Match the route you defined
    icon: <path d="M6 3h12v18l-6-4-6 4V3z" /> 
  },
  { 
    label: 'other mails', 
    path: '/home/temporaryMails', // Add missing path
    icon: (
  ...
  // { 
  //   label: 'Notes', 
  //   path: '/home/notes', // Add missing path
  //   icon: (
  //     <><path d="M4 4h12l4 4v12H4z" /><path d="M15 4v5h5" /><path d="M8 12h8M8 16h5" /></>
  //   )
...
export default function Sidebar() {
  ...
  return (
    <aside className='w-30 bg-stone-900 flex flex-col items-center py-6 gap-2 shrink-0 min-h-screen'>
