  ...
  return (
    <main className='flex-1 px-10 pt-9 pb-16 max-w-7xl relative'>
      ...
      <div className='flex justify-between items-center mb-1.5'>
        <h1 className='font-fraunces text-2xl font-medium'>Saved mails</h1>
      </div>
                ...
                <div key={email.id} className={`p-4 border-b border-stone-200 last:border-b-0 ${isActive ? 'bg-stone-50' : ''}`}>
                  ...
                  <div className='flex items-center justify-end gap-2 mt-3'>
                    ...
                    <button
                      ...
                      className='font-source text-xs px-2.5 py-1 rounded-full border border-black bg-white hover:bg-rose-700 hover:text-creme cursor-pointer'
                    >
                      Delete
                    </button>
                  </div>
